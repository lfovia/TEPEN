...
def hm3d_config(path:str=HM3D_CONFIG_PATH,stage:str='val',episodes=200,robot_height=0.88, 
                     robot_radius=0.25, 
                     sensor_height=0.88,
                     image_width=640, 
                     image_height=480, 
    ...
    print(SCENE_PREFIX + "hm3d_v0.2/hm3d_annotated_basis.scene_dataset_config.json")
    # exit()
    with read_write(habitat_config):
        ...
        habitat_config.habitat.simulator.scene_dataset = SCENE_PREFIX + "hm3d_annotated_basis.scene_dataset_config.json"
        # ----------------------------------
        ...
        # habitat_config.habitat.simulator.scene_dataset_config_file =SCENE_PREFIX + "hm3d_v0.2/hm3d_annotated_basis.scene_dataset_config.json"
...
def mp3d_config(path:str=MP3D_CONFIG_PATH,stage:str='val',episodes=200):
    ...
    with read_write(habitat_config):
        ...
        habitat_config.habitat.simulator.agents.main_agent.sim_sensors.depth_sensor.max_depth=5.0
        habitat_config.habitat.simulator.agents.main_agent.sim_sensors.depth_sensor.normalize_depth=False
        habitat_config.habitat.simulator.forward_step_size=0.35
        habitat_config.habitat.simulator.turn_angle=30
        habitat_config.habitat.task.measurements.success.success_distance = 1.0
        habitat_config.habitat.simulator.habitat_sim_v0.allow_sliding = True
        # habitat_config.habitat.environment.max_episode_steps = 200
    # print(habitat_config)
    return habitat_config
...
def hm3d_data_config(path:str=HM3D_CONFIG_PATH,
    ...
    with read_write(habitat_config):
        ...
        habitat_config.habitat.dataset.data_path = EPISODE_PREFIX + "objectnav/hm3d/v2/{split}/{split}.json.gz"
        habitat_config.habitat.simulator.scene_dataset = SCENE_PREFIX + "hm3d_annotated_basis.scene_dataset_config.json"
        # habitat_config.habitat.simulator.scene_dataset = "data/scene_datasets/hm3d/hm3d_annotated_basis.scene_dataset_config.json" 
        # habitat_config.habitat.simulator.scene_dataset_config_file =SCENE_PREFIX + "hm3d_v0.2/hm3d_annotated_basis.scene_dataset_config.json"
        habitat_config.habitat.environment.iterator_options.num_episode_sample = episodes
        habitat_config.habitat.simulator.agents.main_agent.height=robot_height
        habitat_config.habitat.simulator.agents.main_agent.radius=robot_radius
        ...
        habitat_config.habitat.simulator.agents.main_agent.sim_sensors.depth_sensor.min_depth =0.0
        habitat_config.habitat.simulator.agents.main_agent.sim_sensors.depth_sensor.normalize_depth=False
        # habitat_config.habitat.simulator.semantic_sensor_height = 0.0  # Optional, if present
        habitat_config.habitat.simulator.agents.main_agent.sim_sensors.pop("semantic_sensor", None)

        # # Adding audio sensor for spectrogram data
        # if "audio_sensor" not in habitat_config.habitat.simulator.agents.main_agent.sim_sensors:
        #     # from habitat.config import Config
        #     audio_config=get_config("/home/athira/Pixel-Navigator/habitat-lab/habitat-lab/habitat/config/habitat/task/audionav.yaml")
        
        #     habitat_config.habitat.simulator.agents.main_agent.sim_sensors.audio_sensor = audio_config

        # habitat_config.habitat.simulator.agents.main_agent.sim_sensors.audio_sensor.type = "SpectrogramSensor"

        # habitat_config.freeze()  # Lock modifications

        # audio_config=get_config("/home/athira/Pixel-Navigator/habitat-lab/habitat-lab/habitat/config/habitat/task/audionav.yaml")
        # habitat_config.habitat.simulator.agents.main_agent.sim_sensors.audio_sensor = audio_config
        # habitat_config.habitat.simulator.agents.main_agent.sim_sensors.audio_sensor.type = "SpectrogramSensor"
        # habitat_config.habitat.simulator.agents.main_agent.sim_sensors.audio_sensor.sample_rate = 22050
        # habitat_config.habitat.simulator.agents.main_agent.sim_sensors.audio_sensor.num_mel_bins = 64
        # habitat_config.habitat.simulator.agents.main_agent.sim_sensors.audio_sensor.position = [0, sensor_height, 0]
